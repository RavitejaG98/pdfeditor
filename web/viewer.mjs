...
class Toolbar {
  ...
  constructor(options, eventBus) {
    ...
    const buttons = [{
      ...
      element: options.editorTableButton,
      eventName: "switchannotationeditormode",
      eventDetails: {
        get mode() {
          const {
            classList
          } = options.editorTableButton;
          return classList.contains("toggled") ? AnnotationEditorType.NONE : AnnotationEditorType.INK;
        }
      }
    }, {
  ...
  #editorModeChanged({
    ...
    toggleCheckedBtn(editorTableButton, mode === AnnotationEditorType.INK, editorInkParamsToolbar);
    ...
    editorTableButton.disabled = isDisable;
...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      editorTableButton: document.getElementById("editorTable"),
